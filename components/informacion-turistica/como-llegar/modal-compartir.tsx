...
import RedLinkedin from "@/components/icons/RedLinkedin";
import RedFacebook from "@/components/icons/RedFacebook";
import RedX from "@/components/icons/RedX";
import WhatsappIcon from "@/components/icons/WhatsappIcon";

const ModalCompartir = ({ link = "", disabled = true }) => {
            ...
            <>
              <ModalBody>
                <div className="flex gap-3 pt-10">
                  ...
                  <a
                    href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(`¡Mirá esto! ${link}`)}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    href={`https://wa.me/?text=${encodeURIComponent(`¡Mirá esto! ${link}`)}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    href={`mailto:?subject=${encodeURIComponent("¡Take a look!")}&body=${encodeURIComponent(link)}`}
