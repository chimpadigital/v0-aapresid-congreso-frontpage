  ...
  return (
    <div className="px-4 md:px-8">
          ...
          <div className="space-y-6 xl:max-w-[453px]">
            ...
            <div className="flex justify-between border-b border-primary pb-4">
              <div className="flex flex-1 items-start">
                <p className="mr-2 flex items-center gap-2 text-lg font-bold">
                  ESTUDIANTE{" "}
                  <svg
            ...
            <div className="flex justify-between pb-4">
              <div className="flex flex-1 items-start">
                <p className="mr-2 flex items-center gap-2 text-lg font-bold">
                  ADHERENTE
                  <button
                    data-tooltip-id="tooltip-estudiente"
                    data-tooltip-place="top"
                    type="button"
                  >
                    <svg
      ...
      <Tooltip clickable id="tooltip-adherente">
        ...
        <p className="text-base tracking-wider">
          Deberás adjuntar el convenio vigente
        </p>
      </Tooltip>
    </div>
  );
