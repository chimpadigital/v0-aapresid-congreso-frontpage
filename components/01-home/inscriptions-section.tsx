  ...
  return (
    <section className="mx-auto w-full max-w-7xl px-4 pt-6 md:px-8 md:pt-[68px]">
      <div className="relative flex flex-col md:flex-row">
        ...
        <div className="relative flex w-full items-center justify-center overflow-hidden rounded-t-[30px] bg-primary px-8 py-16 md:w-[calc(50%+20px)] md:rounded-l-[30px] md:rounded-tr-none md:px-16 md:py-20">
        ...
        {isClient && (
          <motion.div
            ...
            className="relative -top-6 flex w-full flex-col items-center justify-center rounded-[30px] bg-accent px-8 py-16 md:top-auto md:-ml-[40px] md:w-[calc(50%+20px)] md:px-16 md:py-20"
          >
