...
const WrapperPreguntasFrecuentes = () => {
  ...
  return (
    <div>
      ...
      <section className="mx-4 mt-[60px] rounded-[28px] bg-[#f0f0f1] px-4 pb-2 pt-[80px] md:mx-[33px] lg:px-8 bg-[url('/images/preguntas-frecuentes/recurso-hexa.webp')] bg-no-repeat bg-right-bottom	">
