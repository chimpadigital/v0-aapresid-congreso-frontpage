...
const DescargaComercialV2 = () => {
  ...
  return (
    <section className="relative mx-4 overflow-hidden rounded-[28px] bg-[url('/images/comercial/bg-formaparte.webp')] bg-cover bg-left md:bg-center bg-no-repeat md:mx-[33px]">
      {/* Contenido */}
